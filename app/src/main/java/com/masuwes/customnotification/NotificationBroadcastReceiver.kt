...
import com.masuwes.customnotification.NotificationService.Companion.CHANNEL_ID
import com.masuwes.customnotification.NotificationService.Companion.CHANNEL_NAME
import com.masuwes.customnotification.NotificationService.Companion.REPLY_ACTION
...
class NotificationBroadcastReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        // catch reply and intent to toast onReceive()
    ...
    // catch intent from getReplyMessageIntent() and show Toast
    override fun onReceive(context: Context, intent: Intent) {
        // This method is called when the BroadcastReceiver is receiving an Intent broadcast.
        if (REPLY_ACTION == intent.action) {
            val message = NotificationService.getReplyMessage(intent) // variable of reply message
            val messageId = intent.getIntExtra(KEY_MESSAGE_ID, 0) // variable of message id
